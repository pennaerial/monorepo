...
0. Follow Setup instructions [here](../../sim/sae%20aero/gazebo%20harmonic/README.md). This should involve copying over our custom setup scripts into your local `PX4-Autopilot` folder.
   Note: Do not need to launch individual components anymore with the new main.launch.py. However, you still need step 6, colcon build, and QGroundControl open before you can run ros2 launch

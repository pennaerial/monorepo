...
# Install dt-apriltags for AprilTag detection
...
# Check AprilTag
echo ""
echo "Testing dt-apriltags..."
python3 -c "from dt_apriltags import Detector; print('✓ dt-apriltags OK')" || echo "✗ dt-apriltags FAILED"
...
echo ""
echo "Next steps:"
echo "1. cd ~/monorepo/controls/sae_2025_ws"
echo "2. colcon build --packages-select uav_interfaces uav"
echo "3. source install/setup.bash"
echo "4. Edit launch_params.yaml:"
echo "   - Set use_camera: true"
echo "   - Set enable_video_stream: true"
echo "5. ros2 launch uav main.launch.py"
echo ""
echo "Configure QGroundControl:"
echo "- Application Settings > General > Video"
echo "- Video Source: UDP h.264 Video Stream"
echo "- Port: 5600"
echo ""
echo "You should see AprilTag detections with bounding boxes in QGC!"
echo ""

...
class CourseParams:
    ...
    def __init__(self, dlz, uav, num_hoops, max_dist, width=None, height=2.0, lateral_offset=4.0,
...
def launch_setup(context, *args, **kwargs):
    ...
    try:
        ...
        elif course_type == "bezier":
            from sim.in_house.courses.bezier import BezierCourse
            course = BezierCourse(
                dlz=course_params_dict['dlz'],
                uav=course_params_dict['uav'], 
                num_hoops=course_params_dict['num_hoops'],

...
class HoopCourseNode(WorldNode):
    ...
    def __init__(self):
        ...
        """
        super().__init__("hoop_course")
        self.config = HoopCourseConfig.model_validate(self.sim_params.world.config)

        self.course = self.config.course
        self.dlz = self.config.dlz
        self.uav = self.config.uav
        self.num_hoops = self.config.num_hoops

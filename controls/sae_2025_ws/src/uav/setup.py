...
setup(
    ...
    py_modules=['uav.UAV', 'uav.UAV_hardware'],
    data_files=[
    ...
    entry_points={
        'console_scripts': [
            ...
            'landing_node = uav.vision_nodes.LandingNode:main',
            'trajectory_planning_node = uav.trajectory_nodes.TrajectoryPlanningNode:main',

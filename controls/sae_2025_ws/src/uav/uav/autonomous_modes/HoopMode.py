...
class HoopMode(Mode):
    """
    A mode for identifying hoops and passing through them.
    """
    ...
    def on_update(self, time_delta: float) -> None:
        ...
        # Camera is FRONT-FACING, therefore we need to transform the x,y,z from the Vision Node to Correct Drone Coordinates
        direction = [response.direction[2], response.direction[0],
                        response.direction[1] / self.altitude_constant]

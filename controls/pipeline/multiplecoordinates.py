...
async def navigate(gps_points, timestamps, drones):
    ...
    for i, point in enumerate(gps_points):
        ...
        # Add the actual navigation logic here, sending commands to the drone
        ...
        # Wait for the specified time before moving to the next point
...
async def run():
    ...
    await navigate(gps_points, drones)

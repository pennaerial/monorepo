...
void IMU_SITL::on_imu_msg(const gz::msgs::IMU& gz_msg)
{
  ...
  ESP_LOGI(
      TAG, "orientation covariance: [%f, %f, %f, %f, %f, %f, %f, %f, %f]", msg.orientation_covariance[0],
  ...
  ESP_LOGI(
      TAG, "angular velocity covariance: [%f, %f, %f, %f, %f, %f, %f, %f, %f]", msg.angular_velocity_covariance[0],
  ...
  ESP_LOGI(
      TAG, "linear acceleration covariance: [%f, %f, %f, %f, %f, %f, %f, %f, %f]",
      msg.linear_acceleration_covariance[0], msg.linear_acceleration_covariance[1],
      msg.linear_acceleration_covariance[2], msg.linear_acceleration_covariance[3],
      msg.linear_acceleration_covariance[4], msg.linear_acceleration_covariance[5],
      msg.linear_acceleration_covariance[6], msg.linear_acceleration_covariance[7],
